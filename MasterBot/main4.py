...
if __name__ == "__main__":
    ...
    class DriveBaseWheels:
        ...
        def drive(self, direction:int, distance:int, granularity=10) -> None:
            print(direction)
            ...
            for i in range(granularity):
                ...
                if i % 2 == 0:
                    ...
                    DriveBase(self.left, self.right, wheel_diameter=self.diameter, axle_track = self.axle_track).straight(round(distance*vertical_mod*(1/granularity)))

                else:

                    DriveBase(self.forward, self.backward, wheel_diameter=self.diameter, axle_track = self.axle_track).straight(round(distance*horizontal_mod*(1/granularity)))
